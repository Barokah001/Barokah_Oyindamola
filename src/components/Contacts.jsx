  ...
  return (
    <section id="contacts" ref={sectionRef} className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div
          className={`mt-16 bg-gray-900 rounded-2xl p-12 text-center transition-all duration-1000 delay-600 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
          ...
          <a href="mailto:alimibarabarakat001@gmail.com">
            <button className="px-8 py-4 bg-white text-gray-900 rounded-full font-bold hover:shadow-2xl transform hover:-translate-y-1 transition-all">
              Get In Touch
            </button>
          </a>
        </div>
